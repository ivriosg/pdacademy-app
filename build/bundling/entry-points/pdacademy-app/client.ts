...
import pdacademy_theme_default from "pdacademy-theme/src/index";
...
if (module["hot"]) {
  module["hot"].accept(
    ...
    () => {
      ...
      const pdacademy_theme_default = require("pdacademy-theme/src/index").default;
