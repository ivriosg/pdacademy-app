...
const Videos = ({ state }) => {
  ...
  return (
    <>
      <h2>Vídeos</h2>
      <p>
        Videotutoriales de diseño, programación y desarrollo de producto de
        menos de 5 minutos. Ahorra tiempo, en todos los sentidos.
      </p>
        ...
        return (
          <article key={id}>
            <Link href={video.link}>
              <Featured imgID={video.featured_media} element="video" />
              <h3
